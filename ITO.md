<!-- AUTOGENERATED doc on 2022-05-05 12:49:16.558952 UTC, do not modify! -->
# Contract
...
| Method | Description | Return |
| ------ | ----------- | ------ |
| :rocket: `new_default_meta` (*constructor*) |  Initialization function (can only be called once).  This initializes the contract with default metadata so the  user doesn't have to manually type metadata. | `Self` |
| :rocket: `new` (*constructor*) |  Initialization function (can only be called once).  This initializes the contract with metadata that was passed in and  the `owner_id`. | `Self` |
...
| ------ | ----------- | ------ |
| &#x24C3; `nft_transfer` |  | `void` |
| &#x24C3; `nft_transfer_call` |  Returns `true` if the token was transferred from the sender's account. | `PromiseOrValue` |
...
*This documentation was generated with* **near-syn v0.3.3** <https://github.com/acuarica/near-syn> *on 2022-05-05 12:49:16.558952 UTC*
